...
const traps = [
  {
    ...
    text: "Дают короткий охлаждающий эффект и ощущение заботы, но не влияют ни на тонус вен, ни на скорость кровотока. Утром тяжесть возвращается.",
  },
  {
    image: pain.url,
    alt: "Покраснение и воспаление на голени",
    title: "Мази и гели",
    text: "Работают поверхностно, на уровне кожи. До глубоких вен голени, где формируется застой, действующее вещество практически не доходит.",
  },
  {
    image: stockings.url,
    alt: "Женщина надевает компрессионный чулок",
    title: "Компрессия «на всякий случай»",
    text: "Нужна и полезна, но её носят днём и снимают на ночь — именно тогда, когда венозный застой достигает максимума.",
  },
  {
    image: nightCramps.url,
    alt: "Ночные судороги в ногах",
    title: "Терпеть и ждать",
    text: "Ночные судороги и жжение — не «возраст», а сигнал. Чем дольше застой, тем тяжелее ноги каждое следующее утро.",
  },
];
